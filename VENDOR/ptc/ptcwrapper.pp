...
{ =====================================================================
  ...
  Copia de packages/ptc/src/ptcwrapper/ptcwrapper.pp de Free Pascal 3.2.2.
  Cambios respecto al original:
    1. Anadido el metodo X11WindowID, que devuelve el identificador X11 de la
  ...
  sigue bajo la LGPL modificada con excepcion de enlazado estatico; se
  conservan intactos los avisos de copyright de arriba. Este aviso cumple el
  requisito de la LGPL de marcar de forma visible los ficheros modificados.
  ===================================================================== }
...
function TPTCWrapperThread.X11WindowID: PtrUInt;
begin
  if Assigned(FConsole) then
